function activation = SigmoidActivationFunction(previousActivation, layerWeights, layerBiases)
%SigmoidActivationFunction Takes in previous layer activations, current
