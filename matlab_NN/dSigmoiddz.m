function dadz = dSigmoiddz(previousActivations,layerWeights,layerBiases)
%dSigmoiddz Derivative of the Sigmoid activation function with respect to
%z, where z = (W*a)+b.
...
activations = SigmoidActivationFunction(previousActivations,layerWeights,layerBiases);
dadz = activations.*(1-activations);
end
