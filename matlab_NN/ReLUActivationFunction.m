function activation = ReLUActivationFunction(previousActivation, layerWeights, layerBiases)
%ReLUActivationFunction Takes in previous layer activations, current
